...
<html lang="en-US">
<head>
    <title>Revisting Ajanta Project</title>
    <meta charset="utf-8">
...
<body id="page-top" class="index">
    ...
    <br/><br/>
     ...
     <div class="container login">
         <?php
							      	  //form-signin is for CSS styling
	$attributes = array('class' => 'form-signinforlogin');
                                                                      
                                                                      
	//Open Form
	//echo form_open('home/login/validate_credentials', $attributes);

    ...
    <body>
        <div class="painting_functions">
            <nav class="w3-sidenav w3-light-grey w3-card-2" style="width:230px">
                ...
                <a href="javascript:void(0)" class="tablink" onclick="openCity(event, 'LineDrawing')" id="defaultOpen">Video 1</a>
                <a href="javascript:void(0)" class="tablink" onclick="openCity(event, 'Reconstructed')">Video 2</a>
                <a href="javascript:void(0)" class="tablink" onclick="openCity(event, 'Jataka')">Video 3</a>
            </nav>
